...
class MarketBannerItem extends StatefulWidget {
  @override
  _MarketBannerItemState createState() => _MarketBannerItemState();
}

class _MarketBannerItemState extends State<MarketBannerItem> {
  // 1
